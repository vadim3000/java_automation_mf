Feature: Journey of regular user with Mix-Pix product, and payment is credit card
@mixpix
  Scenario:  User is available to buy Mix-Pix product

  Given User opens Chrome browser, and moving to the meinfoto shop Mix-pix page
  When User click on CTA "upload button" from MixPix teaser
  And User in configurator and clicks to the CTA "Go to the shopingcart" button
